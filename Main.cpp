...
/*This sets the parameters for the different sorting algoritms and sets the standards, as well as prompting the user for a text file to implement the sorting algoritms on.
 */
#include "UserInput.h"
#include "Sort.h"
#include <iostream>
